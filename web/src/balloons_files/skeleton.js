...
try {
	...
	var __IntegralASConfig = {
		...
		sp_cdnScripts: {xsca: "static.adsafeprotected.com/xsca.17.4.85.js", sca: "static.adsafeprotected.com/sca.17.5.12.js", main: "static.adsafeprotected.com/main.19.8.262.js"},
		protocol: 'https',
		jsref: "https:\/\/googleads.g.doubleclick.net\/",
		asid: "72d0405d-3caa-11ec-b9e9-0e77da516b55",
		...
		mode: "rjss",
		requrl: "",
		dtBaseURL: "https:\/\/dt.adsafeprotected.com\/dt?advEntityId=774604",
		adsafeSrc: "https:\/\/fw.adsafeprotected.com\/rfw\/st\/774604\/58040953\/skeleton.js",
		tpiLookupURL: "",
		getTpl: "false",
		use100v: false,
		useBapiCallback: "",
		useViewabilityNotification: "",
		scriptUrl: "https:\/\/fw.adsafeprotected.com\/rjss\/st\/774604\/58040953\/skeleton.js",
		accountForSadImps: '',
		fwMonitoring: 'false',
		mn: "app11va",
		mobOrTab: false,
		app: false,
		mobAppWebview: false,
		mobFwUrl: "https:\/\/mobile.adsafeprotected.com\/internal\/monitoring\/app\/initial\/774604\/58040953\/",
		anId: '',
		advEntityId: '774604',
		pubEntityId: '58040953',
		videoId: '',
		rts: {},
		customViewability: [],
...
RENDER:{CREATIVE_NODE_TYPES:"CANVAS EMBED IMG OBJECT PICTURE SVG VIDEO".split(" "),CONTAINER_NODE_TYPES:["A","DIV","IFRAME","INS"],WIDTH_THRESHOLD:20,HEIGHT_THRESHOLD:20,STATUS:{OTHER:"0",DETECTED:"1"},DETAILS:{ENVIRONMENT:"env",OTHER:"na"},DIAGNOSTIC:{BROKEN_IMAGE:"bi",UNQUALIFIED_SIZE:"us",QUALIFIED_SIZE:"qs",STYLED_NODE:"sn",TEXT_NODE:"tn",DOCUMENT_READY:"dr",LOAD_FIRED:"lf",CONTENT_STYLED:"cs",MRAID_DEFAULT:"md",MRAID_READY:"mr",MRAID_LOADING:"ml",MRAID_UNKNOWN:"mu",OMID_RENDERED:"or",OMID_UNRENDERED:"ou"}},
RTS_KEY_FOR_VQ:"qiv",UNIQUE_ID_TOKEN:"[IAS_ASID]"},Ba="mf",ma="cm",ta="in",na="pr",oa="po",qb="bl",qa="lo",ra="lt",sa="md",tb="id",db=function(h){return{verifyContextNode:function(){if(!(__IASScope.isDomless||h.contextNode&&null!==h.contextNode.parentNode)){var a,c=M.getElementsByTagName("script"),b=c.length,d=c[b-1],e=h.scriptUrl;try{for(;0<=--b;)if(a=c[b],a.src&&0===a.src.indexOf(e)&&null===a.getAttribute("data-ias-script-tag")){d=a;a.setAttribute("data-ias-script-tag","found");break}}catch(f){}h.contextNode=
d}}}},Fc=function(){var h,a=["STYLE","SCRIPT","HEAD","META"],c=k.RENDER.CREATIVE_NODE_TYPES.concat(k.RENDER.CONTAINER_NODE_TYPES),b=0,d=l.useFIF&&s.friendlyIframe||s.isSpecifiedAd(),e=0,f=[],q=function(q){var p=t.isNodeXDomainIframe(q)||t.isNodeCreative(q),u=!q;h=u?l.contextNode.parentNode:q;if(p||u){var y=f.length;0<y&&(e<y?e=y:(e=0,f=[]));n.getAggregator().trigger("evaluateCreativeFinderResult",q)}else{if(d){var v;v=p=q;u=s.friendly?r.getTop().document.body:l.contextNode.ownerDocument.body;for(;3>
b;){if(u&&p===u){v=p;b=3;break}t.isWindow(p)&&(v=t.crossQuerySelector("["+k.AD_IDENTIFIER+"-"+l.asid+"]"),p=g.isDef(v)?v:p);v=p=g.isDef(p)?p.parentNode||p:p;b++}p=v}else p=q;if(t.isWindow(p)){try{y=p.document}catch(K){y=l.contextNode.ownerDocument}q=y}else"IFRAME"===t.getNodeName(p)?(f.push(q),q=q.contentWindow.document):q=p;var y=[],u=(p=q&&q.getElementsByTagName&&q.getElementsByTagName("*"))&&p.length,w;if(p)for(var A=0;A<u;A++)w=(v=p[A])&&v.nodeName&&v.nodeName.toUpperCase(),!v.children||0!==v.children.length||
g(c).contains(w)||g(a).contains(w)||g(y).contains(w)||y.push(w);y=c.concat(y);(new Ec(y,f)).searchDescendants(q)}};n.getAggregator().on("creativeFinderBatchCompleted",q);return{find:q,getClosestContainerName:function(){return t.getNodeName(h)}}},Ec=function(h,a){var c=function(b){function c(b){var d=t.getNodeName(b),e=t.isNodeCreative(b)||"IFRAME"===d;d&&e&&!t.isEmptyFriendlyFrame(b)&&(d=t.getNodeArea(b),d>m&&!g(a).contains(b)&&(q=b,m=d))}function e(){do c(b[f]),f+=1;while(0!==f%p&&f<b.length);f<
b.length?r.execAtEndOfThread(e,0):n.getAggregator().trigger("creativeFinderBatchCompleted",q)}var f=0,q=null,m=-1,p=500;if(b.length&&n.getAggregator().request("useYieldSearch"))e();else{for(f;f<b.length;f++)c(b[f]);n.getAggregator().trigger("creativeFinderBatchCompleted",q)}};return{searchDescendants:function(a){a=a||l.contextNode.parentNode;var d,e,f=[];for(d=0;d<h.length;d++){e=h[d].toLowerCase();var q=a.getElementsByTagName&&a.getElementsByTagName(e);if(q&&q.length)for(e=0;e<q.length;e++)f.push(q[e])}c(f)}}},
ec=function(){var h,a=!1,c=!1,b=!1,d={status:k.RENDER.STATUS.OTHER,details:k.RENDER.DETAILS.OTHER},e={status:k.RENDER.STATUS.DETECTED,details:k.RENDER.DETAILS.ENVIRONMENT},f=n.getAggregator().request("omidAdSessionContext"),q=function(){b=a=!0},m=function(a){a&&(a.status=k.RENDER.STATUS.DETECTED);n.getAggregator().trigger("adRendered")},p=function(){var a=!1;s.isOmid()&&f&&f.useOMID13Logic&&(a=!0);return a},u=function(a,b){h.save(k.RENDER.DIAGNOSTIC.CONTENT_STYLED);var c=/url(?:\(['"]?)(.*?)(?:['"]?\))/.exec(b.content)[1],
d=t.createImage();d.onload=function(){0<d.naturalHeight*d.naturalWidth&&a.setAttribute&&a.setAttribute("data-ias-rend-bi",!1)};d.src=c;a.setAttribute("data-ias-rend-bi",!0)},y=function(a){var b={},c=r.getDoc(),d=function(e){var f=e&&e.type;if("readystatechange"===f&&"complete"===e.target.readyState||"load"===f)m(b),h.saveNode(a),"readystatechange"===f?h.save(k.RENDER.DIAGNOSTIC.DOCUMENT_READY):"load"===f&&h.save(k.RENDER.DIAGNOSTIC.LOAD_FIRED),w(b),z.removeEvent(a,"load",d),z.removeEvent(c,"readystatechange",
d)};"complete"===c.readyState?(m(b),h.saveNode(a),h.save(k.RENDER.DIAGNOSTIC.DOCUMENT_READY)):(z.addEvent(a,"load",d),z.addEvent(c,"readystatechange",d));return b},v=function(){var a=r.getWindow().mraid,b=a&&a.getState&&a.getState(),c=function(){z.removeEvent(a,"ready",c);h.save(k.RENDER.DETAILS.ENVIRONMENT);h.save(k.RENDER.DIAGNOSTIC.MRAID_READY);m();w({status:k.RENDER.STATUS.DETECTED})};h.save(k.RENDER.DETAILS.ENVIRONMENT);"default"===b?(m(),h.save(k.RENDER.DIAGNOSTIC.MRAID_DEFAULT),d.status=k.RENDER.STATUS.DETECTED):
"loading"===b?(z.addEvent(a,"ready",c),h.save(k.RENDER.DIAGNOSTIC.MRAID_LOADING)):(z.addEvent(a,"ready",c),h.save(k.RENDER.DIAGNOSTIC.MRAID_UNKNOWN));w(d)},l=function(a){a===k.RENDER.STATUS.DETECTED&&n.getAggregator().trigger("perfCheckpoint",{type:k.PERF_TIMELINE_TRACKER_CONFIG.RENDER.TYPE,timestamp:r.now(),code:k.PERF_TIMELINE_TRACKER_CONFIG.RENDER.CODE})},w=function(b){var c=h.build();b=b.status||d.status;c=c?c:d.details;a&&b===k.RENDER.STATUS.DETECTED?(l(b),n.getAggregator().trigger("addThrottledOutputItem",
"rend",b),n.getAggregator().trigger("addThrottledOutputItem","renddet",c)):(l(b),n.getAggregator().trigger("addOutputItem",{output:b},"rend"),n.getAggregator().trigger("addOutputItem",{output:c},"renddet"))},A=function(){n.getAggregator().on("primaryadfound",function(a){var b,c=d,e=new Fc,f=!0;n.getAggregator().on("evaluateCreativeFinderResult",function(a){if(t.isNodeXDomainIframe(a))b?r.clearInterval(b):f=!1,c=y(a);else if(a){var d=!1,q=t.getRect(a),p;if(p=a&&"IMG"===t.getNodeName(a)){p=!0;var v=
g.isDef(a.naturalWidth)?a.naturalHeight*a.naturalWidth:0,l=getComputedStyle(a),n=0===a.src.length&&H.contains(l.content,"url"),A=a.getAttribute&&a.getAttribute("data-ias-rend-bi");0<v&&!n&&(p=!1);"false"===A&&(h.save(k.RENDER.DIAGNOSTIC.CONTENT_STYLED),p=!1);n&&!A&&u(a,l)}p&&(d=!0,h.save(k.RENDER.DIAGNOSTIC.BROKEN_IMAGE));!d&&q.width>=k.RENDER.WIDTH_THRESHOLD&&q.height>=k.RENDER.HEIGHT_THRESHOLD&&(m(c),b?r.clearInterval(b):f=!1);h.saveNode(a)}else a=e.getClosestContainerName()||h.getAdNodeName(a)||
c.details,h.save(a);w(c)});var q=function(){var b=a&&a.getAdNode();try{e.find(b)}catch(c){n.getAggregator().trigger("renderdiag",c)}},p=n.getAggregator().request("mobileApp");p&&p.isMobileAppEnvironment&&p.isMobileAppEnvironment()&&s.isMraid()?v():(q(),f&&(b=r.setInterval(q,500)));n.getAggregator().trigger("eligiblerender")})},F=function(){var a=f&&!!f.isVideo,b=!p()||f&&!!f.videoStartArrived,d=!p()||f&&!!f.geometryArrived,q=!f.omidEarlyExit||f.omidImpressionArrived,g=!(f.omidEarlyExit&&p())||f.omidLoadedArrived;
...
n.getAggregator().provide("useYieldSearch",function(){return b});h=new Gc;new Hc;n.getAggregator().on("impressionsent",q);p()||f.omidEarlyExit?F()||(h.save(k.RENDER.DETAILS.ENVIRONMENT),h.save(k.RENDER.DIAGNOSTIC.OMID_UNRENDERED),w(d),n.getAggregator().on("omidrendgeoupdate",function(){F()}),n.getAggregator().on("omidrendvideostart",function(){F()}),f.omidEarlyExit&&(n.getAggregator().on("omidimpressionarrived",function(){F()}),n.getAggregator().on("omidloadedarrived",function(){F()}))):s.isAvid()||
s.isOmid()||s.isVideo()?(n.getAggregator().trigger("eligiblerender"),h.save(e.details),m(),w(e)):(w(d),A())}}},Gc=function(){var h=[],a=[],c=function(a){var c;if(t.isWindow(a))c="WINDOW";else if(t.isNodeXDomainIframe(a))c="XIFRAME";else try{c=t.getNodeName(a)}catch(f){b("nen")}return c},b=function(a){h.push(a)};return{build:function(){var b=[];g(a).each(function(a,c){b.push(c)});g(h).each(function(a,c){b.push(c)});a=[];h=[];return b.join(".")},getAdNodeName:c,save:b,saveNode:function(d){try{var e=
d&&c(d),f=d&&t.getRect(d),q=d&&t.hasBackgroundImage(d),m=d&&d.innerText&&0<d.innerText.length,p=d&&d.children&&0===d.children.length&&m,h=f&&f.width>=k.RENDER.WIDTH_THRESHOLD&&f.height>=k.RENDER.HEIGHT_THRESHOLD?k.RENDER.DIAGNOSTIC.QUALIFIED_SIZE:k.RENDER.DIAGNOSTIC.UNQUALIFIED_SIZE;a.push(e);a.push(h);q&&a.push(k.RENDER.DIAGNOSTIC.STYLED_NODE);p&&a.push(k.RENDER.DIAGNOSTIC.TEXT_NODE)}catch(g){b("sne")}}}},Hc=function(h){var a,c=!1,b=!1,d=function(){n.getAggregator().trigger("addOutputItem",{output:!a&&
c?"1":"0"},"rmeas");a&&a.message&&!b&&(__IntegralASDiagnosticCall("renderloop",a,l),n.getAggregator().trigger("addThrottledProp",k.DT_SLOT.ENVIRONMENT,"rle",1),b=!0)};n.getAggregator().on("eligiblerender",function(){c=!0;d()});n.getAggregator().on("renderdiag",function(b){a=b;d()});d()},Z=function(){return{applies:function(h,a){var c=n.getAggregator().request("mobileApp");return(h.browserIs(k.BROWSERS.CHROME)||h.isAndroidWebViewBrowser()||h.browserIs(k.BROWSERS.WEBKIT)||h.browserIs(k.BROWSERS.MSEDGE))&&
!c.isMobileAppEnvironment()&&h.hasIntersectionObserver()}}},Ic=function(){return{applies:function(h){var a=n.getAggregator().request("mobileApp");return(h.browserIs(k.BROWSERS.CHROME)||h.isAndroidWebViewBrowser()||h.browserIs(k.BROWSERS.WEBKIT)||h.browserIs(k.BROWSERS.MSEDGE))&&!a.isMobileAppEnvironment()&&h.hasResizeObserver()}}},hb=function(){var h,a,c=!1,b=n.getAggregator().request("mPage"),d=function(){!c&&a&&h&&!b.isHidden()&&(c=!0,n.getAggregator().trigger("sendDt",k.DT_CODES.LARGE_BILLABLE))};
n.getAggregator().on("primaryadfound",function(a){h=a.getDims().area()>=k.MRC_LARGE_AD_SIZE;d()});n.getAggregator().on("impressionsent",function(){a=!0;d()});b.onHiddenChange(d)},Nb=function(){var h=[],a={},c={percentInView:"piv",sl:"vs",reason:"r",width:"w",height:"h",omidObstructions:"oobs"},b={omidObstructions:["sl","percentInView","reason"]};n.getAggregator().on("newScreenEvent",function(b){b=g(b).selectProperties(g(c).keys());b=g(b).asStrings();var f=g(b).compareTo(a);(f=d(f))&&JSON.stringify(f)!==
JSON.stringify({})&&(f.t=s.getTagTime(),h.push(f));g(a).mixin(b)});var d=function(a){g(b).each(function(b,c){var d=!1;g(c).each(function(b,c){a[c]&&(d=!0)});!1===d&&delete a[b]});return a};return{toString:function(){return g(h).toION(c)}}},Fa=function(){var h=new Jc,a=new E;return g(h).mixin(a)},E=function(){var h={},a={},c=function(b,c,f){if((b=a[b])&&0!==b)return f&&(b=b.slice(0,1)),g(b).each(function(a,b){c.apply({},b)}),!0},b=function(a,b,c){h[a]=h[a]||new ca;h[a].push(b,c)};return{on:function(a,
e){var f={};e?f[a]=e:f=a;g(f).each(b);g(f).each(c)},once:function(a,e){c(a,e,!0)||b(a,e,1)},trigger:function(a){var b=g(arguments).toArray();b.shift();var c;(c=h[a])&&c.run.apply({},b)},persistentTrigger:function(b){var c=g(arguments).toArray();c.shift();var f=b;a[f]=a[f]||[];a[f].push(c);(f=h[b])&&f.run.apply({},c)}}},da=function(){var h=function(a,b,d){var e,f=b.length,q=t.isWindow(a)?a.frames:t.getChildWindowsOf(a);d&&d(a,b);if(q&&q.length){for(a=0;a<q.length;a++)(e=q[a])&&t.isWindow(e)&&(b[f]=
a,h(e,b,d));b.pop()}},a=function(a,b){try{h(b||top,[0],a)}catch(d){}};return{traverse:a,getFrames:function(c,b){var d=[];a(function(a){var b;if(b=t.isWindow(a)){var c=!0;for(b=0;b<d.length;b++)if(d[b]===a){c=!1;break}b=c}b&&d.push(a)},b);return g(d).filter(c)}}},ca=function(){var h=[];return{push:function(a,c){var b=0;c=c||Number.MAX_VALUE;h[h.length]=function(){b<c&&(b++,a.apply({},arguments))}},run:function(){var a=arguments;g(h).each(function(c,b){b.apply({},a)})}}},za=function(h){var a={};return{doEligibleJobs:function(c){g(h).each(function(b,
d){var e=d&&d.getTime();g.isDef(e)&&c>=e&&!a[e]&&(d.getTask().call(),a[e]=!0)})}}},Ha=function(){var h,a=new ea,c=function(b,c,e,f){var q,m,p,h;if(JSON&&JSON.parse)try{q=JSON.parse(b.data),m=b.source,h=g.noop,c(q)&&(f&&(p=f(m,q))&&(h=function(){a.send(function(){return p},m)}),e(b,q,h))}catch(y){q&&n.getAggregator().trigger("error",k.ERROR_CODES.MESSAGE_LISTENER)}};return{listen:function(a,d,e){h=function(f){c(f,a,d,e)};z.addEvent(x,"message",h)},stop:function(){h&&z.removeEvent(x,"message",h);h=
null}}},ea=function(){var h=function(a){return g(a).isObj()?[a]:(new da).getFrames(a)},a=function(a){return g(a).mapToObj(function(a,c){var e;g.isFunction(c)||(e={},e[a]=c);return e})};return{send:function(c,b){if(JSON&&JSON.stringify){var d=h(b);g(d).each(function(b,d){var q;q=g.resolve(c,d)||{};q.sentTime=r.now();q=a(q);d.postMessage(g(q).JSONStringify(),"*")})}}}},Kc=function(h,a){return{onAll:function(c){var b={};g(a).each(function(d,e){h.on(e,function(){b[e]=1;g(b).keys().length===a.length&&
(b={},c())})})}}},Ib=function(h){var a=0,c={},b=function(b,c,d){if(g.isUndef(b.output))throw Error("item with id "+c+' must have "output" method');this.item=b;this.id=c||++a;this.props=d||{};this.output=function(){var a=g.resolve(b.output);this.props.asION&&(a=g(a).toION());return a}},d=function(a){var b,d,e=[];for(b in c)c.hasOwnProperty(b)&&(d=a(b,c[b]))&&e.push(d);return e},e=function(a,d,e){e=e||d;e="string"!==typeof e?e:{};var p=function(a,d,e){a=new b(a,d,e);c[a.id]=a};g(a.output).isObj()&&
!e.asION?g(a.output).each(function(a,b){p({output:b},a,e)}):p(a,d,e)};h.on("addOutputItem",function(a,b,c){e(a,b,c)});return{addItem:e,filterOutput:function(a,b){return d(function(c,d){var e=d.props,h;a(e)&&(h=d.output(),e.encode&&(c=encodeURIComponent(c),h=encodeURIComponent(h)),g.isFunction(b)?b(c,h):b[c]=h)})},iterate:d,cleanup:function(){d(function(a,b){b.props.flagForRemoval&&delete c[a]})},getItem:function(a){return c[a]}}},Jc=function(){var h={},a=function(a,b){h[a]=b};return{request:function(a){var b,
d=h[a],e=g(arguments).toArray();e.shift();g.isUndef(d)||(b=g.isFunction(d)?d.apply({},e):d);return b},provide:function(c,b){b?h[c]=b:g(c).each(a);return b}}},Yb=function(){return{createInstance:function(h,a,c,b){return s.isDomless()?new Lc:new Mc(h,a,c,b)}}},Mc=function(h,a,c,b){var d;return{collect:function(){var a=h.find(),f=a.getOutOfViewReasons(),q=c.isHidden(),m=b.isDeviceTypeGroupMobile()&&d?d:C(t.calcWinDims()),p=a.getDims();d=m;if(!a.hasAd()||!m.hasValidDims()||!p.hasValidDims())return{viewState:k.NA,
...
tabHidden:g.stringifyTriState(q),posViewState:a.getViewState(),adCompCount:a.getComponentCount(),sliceStatus:a.getSliceStatus()}}}},Lc=function(){return{collect:function(){return{}}}},Nc=function(h){h=h||g.identity;var a=[],c=r.now(),b=function(){var b=r.now();a.length&&(a[a.length-1].duration+=b-c,c=b)};return{clear:function(){b();a=[]},fastForward:b,get:function(){return a},hasAlwaysBeen:function(b){return 1===a.length&&a[0].state===b},addState:function(c){var e=a[a.length-1];c=h(c);b();0!==a.length&&
c===e.state||a.push({state:c,duration:0})}}},Ia=function(h,a){var c=h||1,b=0,d=0,e,f=0;return{start:function(){0===b%c&&(e=r.now())},stop:function(){var q=e||a;0===b%c&&(f+=r.now()-q,d++);b++},getTime:function(){return f},getCount:function(){return d}}},Ja=function(){var h,a=0,c=0,b=new E(!0),d=function(){h&&(a++,b.trigger(a),c>a?r.execAtEndOfThread(d):e())},e=function(){h=!1;a=0};return{onTick:function(a,d){var e=g.collapseArgsIntoHash(a,d);g(e).each(function(a,b){a=parseInt(a);c=a>c?a:c});b.on(e)},
start:function(){h||(h=!0,r.execAtEndOfThread(d))},kill:e,isActive:function(){return h}}},Oc=function(h,a){var c,b=a,d=function(a){c||(a&&h(),c=r.setInterval(h,b))},e=function(a){c&&(a&&h(),r.clearInterval(c),c=null)};return{start:d,stop:e,updateFrequency:function(a,q){b=a;c&&(e(),d(q))}}},Y=function(h){var a,c,b=0,d=s.getTagTime(),e=0,f=!1;return{getTotalTime:function(){return e},stop:function(){b=0;d=s.getTagTime();f=!1},mark:function(){a=f?s.getTagTime()-d:0;b+=a;b>=h&&(c=b-a<h,e+=c?b:a);d=s.getTagTime();
f=!0}}},R=function(h,a){var c=h||l.adsafeSrc||l.requrl;c&&0===c.indexOf("http")||(c=0===c.indexOf("//")?l.protocol+":"+c:l.protocol+"://"+c);var c=/((http|https):\/\/(([^\/\.]*)\.([^\/]*)))(?:\/(.[^?]*)\??(.+)?)*/.exec(c)||[],b=c[1]?c[1]:"",d=c[2]?c[2]:"",e=c[3]?c[3]:"",f=c[4]?c[4]:"",q=c[5]?c[5]:"",m=h&&c[6]?c[6]:"",p=c[7]&&a?c[7]:"",u={},y=function(a){"string"===typeof a&&(f=a);return f},v=function(a){"string"===typeof a&&(q=a);return q},k=function(a,b){var c=a+"="+g(b).toION();return g.encodeInvalidUrlChars(c,
l.encodeInvalidUrlChars)},p=p?p.replace(/&$/,""):"";return{appendToParamValue:function(b,c){var d,e;(d=u[b])?u[b]=d+c:a&&p.length&&(d=p.split(b),e=1<d.length)&&(e=d[1].split("&")[0],d=[d[0],e].join(b),p=p.replace(d,d+c))},fullDom:b,hostname:e,sub:y,master:v,setParam:function(a,b){u[a]=u[a]||{};"string"===typeof b||"number"===typeof b?u[a]=b:g(u[a]).mixin(b)},path:function(a){m=a},toString:function(){var a=y()?y()+".":"",b=m?"/"+m:"",c;p||!g(u).isEmpty()?(c=g(u).isEmpty()?"":g(u).stringify(k,"&"),
c="?"+p+(p&&c?"&"+c:c)):c="";return d+"://"+a+v()+b+c}}},ob=function(){var h=function(a){var b=[];g(a).each(function(a,c){400>=b.concat(c).join("").length&&b.push(c)});return b},a=function(a,b){var d;b&&b.id&&(d=b.id.replace(/[^\w-_.>\/]/g,""));return d};return function(){var c,b;try{if(s.friendly&&!s.isMobileApp())if(c=n.getAggregator().request("adSlotIds"))b=c;else{var d,e;if(d=t.getOurNodeInTop()){var f=t.getAncestorNodes(d);e=g(f).map(a)}if(c=e=e&&h(e))n.getAggregator().trigger("addOutputItem",
...
c(a,b)))return!0}}},xe=[{PARTNER_NAME:"IAB"},{PARTNER_NAME:"IAS"},{PARTNER_NAME:"com.integralads.omid.iassdk"}],ye=function(){return{listenForResult:function(){n.getAggregator().on("videoBlockResult",function(a){var c=n.getAggregator().request("adNode"),b=!1,d="blockAd"+l.videoId;"failed"===a.action&&(b=!0);if(c&&g.isDef(c.blockAd))c.blockAd(b);else if(c&&g.isDef(c[d]))c[d](b)})}}},ze=function(a,c){var b=n.getAggregator().request("videoTranslator").translate(a.messageType),d=function(a){a=a.eventData||
{};a=g({}).mixin(a);a.ext_passthrough&&delete a.ext_passthrough;return a}(a),e=function(a){var b;a=a.eventData&&a.eventData.ext_passthrough;var c=function(a,b){var c={};c["x_"+a]=b;return c};a&&(b=g(a).mapToObj(c));return b}(a),f={t:a.time-l.birthdate,tp:b,sl:c};g(f).mixin(d);g(f).mixin(e);var k=g({indicatesPlaying:function(){return-1!=="showAd|adImpression|adVideoStart|resumeAd".indexOf(b)},indicatesNotPlaying:function(){return-1!=="adVideoComplete|adStopped|stopAd|pauseAd".indexOf(b)},indicatesFullscreen:function(){var a=
r.getWindow();return("resizeAd"===b||"initAd"===b)&&("fullscreen"===d.viewMode||d.width===a.screen.width)},indicatesNormalSize:function(){return"resizeAd"===b&&"normal"===d.viewMode},indicatesQuartile:function(){return-1!=="adVideoFirstQuartile|adVideoMidpoint|adVideoThirdQuartile|adVideoComplete".indexOf(b)},indicatesCompletion:function(){return-1!=="adStopped|adVideoComplete|adSkipped|adError".indexOf(b)},getVolume:function(a){return a.getVolumeFromContext(d)},updateScreenLoc:function(a){f.sl=a;
k.sl=a},trigger:function(){"adImpression"===b?n.getAggregator().persistentTrigger(b,d,e):n.getAggregator().trigger(b,d,e)},toString:function(){return"{"+g(f).toParams()+"}"}}).mixin(f);return k},Ae=function(){var a=[];return{registerEvent:function(c,b){var d=ze(c,b);a.push(d);return d},toString:function(){return"{"+g({vEventCount:a.length,vEvents:"["+a.join(",")+"]"}).toParams()+"}"},isEmpty:function(){return 0===a.length}}},Be=function(){var a,c,b,d=function(d){b=g.isDef(d)?0===d:b;c&&b&&a.addState({isFullyInView:function(){return!1}})},
e=function(){a&&a.hasAlwaysBeen(!0)&&n.getAggregator().trigger("sendDt",k.DT_CODES.QUARTILE_FULLY_INVIEW)},f=function(){c=!0;d()},l=function(a){a=(new ab).getVolumeFromContext(a);d(a)};return{isApplicable:function(a){return a.usesGroupMCustomMetric()},start:function(b){n.getAggregator().on({adVideoStart:f,adImpression:f,volumeChanged:l,adVideoMidpoint:e});a=b.createViewabilityTracker("mpt",function(a){var b=n.getAggregator().request("isFullyInViewProvider");return!c||b&&b.isFullyInView(a)})}}},Ce=
function(){var a={AdPaused:"pauseAd",AdVolumeChange:"volumeChanged",AdPlaying:"resumeAd"};return{translate:function(c){var b=c.charAt(0).toLowerCase()+c.slice(1);c in a&&(b=a[c]);return b}}},ab=function(){return{getVolumeFromContext:function(a){var c,b=-1;g.isDef(a)&&(g.isDef(a.volume)?b=a.volume:g.isDef(a.adVolume)&&(b=a.adVolume));-1!==b&&(c=b);return c}}},Cb=function(a,c,b){var d="IASid"+a,e="getIasVidBridgeVersion"+a,f,q,m,p=[],u=k.OUT_OF_VIEW,t=!1,v=!1,x=!1,w=!0,A=new Ae,F=Be(),B=new ye,D=new ab,
E=new Ma,G=function(c){var d;t=!0;var e={};try{e=JSON.parse(unescape(c&&c.data?c.data:c))}catch(f){e={}}e.id==a&&(d=A.registerEvent(e,b.getCurrentLoc()),d.indicatesPlaying()?(v=!0,u=x?k.IN_VIEW:!1):d.indicatesNotPlaying()?(v=!1,u=k.OUT_OF_VIEW):d.indicatesFullscreen()?(x=!0,u=v?k.IN_VIEW:k.OUT_OF_VIEW):d.indicatesNormalSize()&&(x=!1,u=v?!1:k.OUT_OF_VIEW),c=parseFloat(d.getVolume(D)),0<c?w=!0:0===c&&(w=!1));p.push(d);m&&H();return d},C=function(b){var c,f,k=Ca().wrapToGlobal(G),m=function(a){g.isStr(a)&&
(n.getAggregator().provide("vc",function(){return a}),n.getAggregator().trigger("addOutputItem",{output:a},"vc",{type:"impression"}))};try{f=b[e]||b.getIasVidBridgeVersion,c=g.isFunction(f)&&"2"===f.call(b)?unescape(b[d].call(b,a,k)):unescape(b[d].call(b,a)),t=!0,m(c||"n")}catch(p){__IntegralASDiagnosticCall("handshakefailure",p,l)}},I=function(){var b=function(a){return g(g(a).toArray()).findFirst(function(a,b){return g.isFunction(b[d])})};f||(g(["*[data-integralas-vid-"+a+"]",".integral-vid-"+a,
"ias-ad","object","embed"]).findFirst(function(a,c){var d=r.getDoc().querySelectorAll(c);return f=b(d)}),!f&&c.on("novidnodeerr")&&0.1>Math.random()&&__IntegralASDiagnosticCall("novidnode",{message:"node not found*10"},l));return f},L=function(){var a=I();a&&!t&&C(a);return a},J=function(a){a=D.getVolumeFromContext(a);w=g.isDef(a)?0<a:!1},H=function(){E.init();g(p).each(function(a,c){c&&(g.isUndef(c.sl)&&c.updateScreenLoc(b.getCurrentLoc()),c.trigger(),c.indicatesCompletion()&&n.getAggregator().trigger("adSessionComplete"),
